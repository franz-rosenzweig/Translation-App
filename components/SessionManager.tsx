  ...
  if (!isOpen) {
    return (
      <div className="flex gap-2 mb-4">
        ...
        <button
          className="flex items-center gap-2 px-3 py-2 text-sm border rounded hover:bg-gray-100 dark:hover:bg-gray-800 disabled:opacity-50"
  ...
  return (
    <div className="border rounded-lg p-4 mb-4 bg-gray-50 dark:bg-gray-900">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-medium">Translation Sessions</h3>
